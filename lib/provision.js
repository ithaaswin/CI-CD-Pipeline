...
class Builder{
    ...
    async windows(name)
    {
        ...
        let keyname = newData.keyPath.split('/')[-1];
        ...
        child.execSync(`ssh -q -i "~/.bakerx/insecure_private_key" -p ${configport} -o StrictHostKeyChecking=no vagrant@127.0.0.1 "chmod 600 .ssh/vm-server"`, {stdio: 'inherit'});
    }
