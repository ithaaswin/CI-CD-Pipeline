					...
					if( getDropResponse.data.droplet ){
						...
						droplet.networks.v4.forEach(i => {
							if(i.type == 'public'){
								...
								// droplet_info=inventoryDic;
								// inventory[dropletserver]={response.data.droplet.id i.ip_address}
								// inventory[dropletserver].append(response.data.droplet.ip_address)s
								// Object.assign(inventory[dropletserver], inventoryDic)
