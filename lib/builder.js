...
class Builder{
    ...
    async dpkgLock(processor){
        ...
        await this.vmExecute(processor, "sudo rm -rf /var/lib/dpkg/lock");
        await this.vmExecute(processor, "sudo rm -rf /var/lib/dpkg/lock-frontend")
        await this.vmExecute(processor, "sudo rm -rf /var/lib/apt/lists/lock");
        await this.vmExecute(processor, "sudo rm -rf /var/cache/apt/archives/lock");
    }
